...
Internet Service Provider Customer Churn - "https://www.kaggle.com/datasets/mehmetsabrikunt/internet-service-churn"
...
# 각 모델의 성능지표 확인(각 Scaler에 따른)

사전조건

1. 결측치는 0으로 대체하여 진행한다.
2. 하이퍼 파라미터는 random_state = 42로 모든 모델을 고정한다.
2. ['id'] 컬럼은 학습에 필요 없으니 제거한다.
3. ['remaining_contract'] 컬럼은 과적합의 우려가 있어 제거하고 학습한다.
